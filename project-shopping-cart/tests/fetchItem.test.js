...
describe('2 - Teste a função fecthItem', () => {
  beforeEach(async () => result = await fetchItem('MLB1615760527'));
  ...
  it('Testa se o retorno da função fetchItem com o argumento do item "MLB1615760527" é uma estrutura de dados igual ao objeto item que já está importado no arquivo', () => {
  ...
  it('Testa se, ao chamar a função fetchItem sem argumento, retorna um erro com a mensagem: You must provide an url', async () => {
    ...
    const newResult = await fetchItem();
